function ping_Pong_test(p) {
    ...
    p.setup = function () {
        ...
        p.noLoop();
        p.describe('Two narrow white rectangles and a white square representing the paddles and ball in a game of ping pong. The player scores are displayed in the upper corners, and initially text reads "Click to start"');
    };
    ...
    p.draw = function() {
        ...
        paddleLeftY = p.constrain(paddleLeftY + leftMove, paddleHeight / 2, p.height - paddleHeight / 2);
        ...
        paddleRightY = p.constrain(paddleRightY + rightMove, paddleHeight / 2, p.height - paddleHeight / 2);
